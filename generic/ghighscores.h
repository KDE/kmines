 ...
 * See @Highscores for usage example.
 *
 ...
 *      aborts a game and you consider it is somehow cheating the
 *      statistics </li>
...
class Highscores
{
 public:
     ...
     * with @ref addToQueryURL. By default this method do nothing.
     *
    ...
    /**
     * Add an entry to the url to be called (@see additionnalQueryItems).
     *
